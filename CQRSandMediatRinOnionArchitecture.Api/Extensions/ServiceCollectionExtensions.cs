using CQRSandMediatRinOnionArchitecture.Api.Services;
using CQRSandMediatRinOnionArchitecture.Application.DTOs.Settings;
using CQRSandMediatRinOnionArchitecture.Application.Interfaces;
...
using CQRSandMediatRinOnionArchitecture.Infrastructure.Identity.Services;
using CQRSandMediatRinOnionArchitecture.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\CQRSandMediatRinOnionArchitecture.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "CQRSandMediatRinOnionArchitecture",
